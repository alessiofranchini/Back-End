...
//		List<Utente> listaUtente; /*UT*/
		...
		try {
            ...
            Tratta TA11 = new Tratta();
            TA11.setNome_tratta("Cs-Fi");
            TA11.setPartenza("Cosenza");
            TA11.setCapolinea("Firenze");
          ...
          addElement(TA11);*/
            ...
            UT1.setNome("Daniele");
            UT1.setCognome("Migani");
            UT1.setTessera(TS1);
            Utente UT2 = new Utente();
            UT2.setNome("Alessio");
            UT2.setCognome("Franchini");
            UT2.setTessera(TS2);
            Utente UT3 = new Utente();
            UT3.setNome("Antonio");
            UT3.setCognome("Caputo");
            UT3.setTessera(TS3);
            Utente UT4 = new Utente();
            UT4.setNome("Giorgia");
            UT4.setCognome("Simeoni");
            UT4.setTessera(TS4);
            Utente UT5 = new Utente();
            UT5.setNome("Emanuele");
            UT5.setCognome("Umberto");
            UT5.setTessera(TS5);
            /*addElement(UT1);
            addElement(UT2);
            addElement(UT3);
	...
	public static void creazioneTratta() {
	 ...
	 public static void creazioneMezzo() {
	        System.out.println("Inizio creazione mezzo");
	        ParcoMezzi TM1 = new ParcoMezzi();

	        System.out.println("Il mezzo che stai creando dovrà essere assegnato ad una tratta:");
	        System.out.println("Premi 1 se conosci già la tratta");
	        ...
	        String nome_mezzo = scanner.nextLine();
	        TM1.setNome(nome_mezzo);

	        System.out.println("Questo mezzo è in servizio:");
	        ...
	        System.out.println("Inserisci il codice della tratta");
	        ...
	        try {
	            ...
	            em.persist(TM1);
	            em.getTransaction().commit();
	            System.out.println("Mezzo creato e salvato nel database con successo.");
	        } catch (Exception e) {
	            if (em.getTransaction().isActive()) {
	                em.getTransaction().rollback();
	            }
	            System.out.println("Si è verificato un errore durante il salvataggio del mezzo nel database.");
	            e.printStackTrace();
	        } finally {
	            em.close();
	        }
    ...
    public static void nuovoAbbonamento() {
        ...
        } else if (sceltaDurata == 2) {
            AB1.setDurata(TipoAbbonamento.SETTIMANALE);
        } else {
            System.out.println("Scelta non valida. Durata impostata come mensile di default.");
            AB1.setDurata(TipoAbbonamento.MENSILE);
        }

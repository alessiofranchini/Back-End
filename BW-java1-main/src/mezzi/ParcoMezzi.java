...
public class ParcoMezzi {
    ...
    private LocalDate data_manutenzione;
    ...
    public ParcoMezzi(TipoMezzo tipo_mezzo, String nome, boolean in_Servizio, LocalDate data_manutenzione,
            int capienza) {
        this.tipo_mezzo = tipo_mezzo;
        this.nome = nome;
        this.in_servizio = in_servizio;
    ...
    public void setDataManutenzione(LocalDate dataManutenzione) {
        this.data_manutenzione = dataManutenzione;
    }
